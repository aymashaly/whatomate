    ...
    <ScrollArea v-else class="flex-1">
      <div class="p-6 space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-3">
          ...
          <RouterLink to="/app/chatbot/app/flows" class="card-interactive rounded-xl border border-white/[0.08] bg-white/[0.02] h-full light:bg-white light:border-gray-200">
            <div class="p-6">
              <div class="flex items-center gap-3">
        ...
        <div class="rounded-xl border border-white/[0.08] bg-white/[0.02] light:bg-white light:border-gray-200">
          <div class="p-6">
            <div class="flex items-center justify-between">
              ...
              <RouterLink to="/app/settings/app/chatbot">
